...
import 'package:docflow/features/document_list/presentation/screens/document_list_screen.dart';
...
class PaywallScreen extends StatelessWidget {
  ...
  void _handleSubscriptionSuccess(BuildContext context, bool isRestore) {
    if (isModal) {
      ...
      print("Navigating to Documents Screen"); // добавим для отладки
      // Убедимся что мы точно используем DocumentsScreen, а не DocumentListScreen
      final documentsScreen = const DocumentsScreen();
      print("Screen to navigate: ${documentsScreen.runtimeType}"); // для отладки
      ...
      child: BlocConsumer<SubscriptionBloc, SubscriptionState>(
        listener: (context, state) {
          if (state is SubscriptionActive) {
            ...
            // Показываем ошибку при неудачном восстановлении
